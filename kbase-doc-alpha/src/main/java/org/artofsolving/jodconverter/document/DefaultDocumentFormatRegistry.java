...
public class DefaultDocumentFormatRegistry extends SimpleDocumentFormatRegistry {
	...
	public DefaultDocumentFormatRegistry() {
		...
		xlsx.setStoreProperties(DocumentFamily.SPREADSHEET, Collections.singletonMap("FilterName", "MS Excel 2007 XML"));
        addFormat(xlsx);
		...
		pptx.setStoreProperties(DocumentFamily.SPREADSHEET, Collections.singletonMap("FilterName", "MS PowerPoint 2007 XML"));
        addFormat(pptx);
